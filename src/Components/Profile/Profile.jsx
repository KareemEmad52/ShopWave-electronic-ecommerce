      ...
      <div className='w-full flex justify-center items-center py-5 md:px-5'>
        <div className='w-fit border-spacing-2  border border-main-200 transition-all duration-500 hover:border-main-500 rounded-md py-4 px-2 md:px-8'>
          ...
          <div className='mx-auto w-36 md:w-40 rounded-full py-8'>
            <img class="mx-auto h-auto w-full rounded-full border border-alternative-100 hover:border-alternative-200 duration-500 transition-all border-spacing-1" src={userInfo?.profilePicture?.path ? userInfo?.profilePicture?.path : 'https://i.pinimg.com/736x/0d/64/98/0d64989794b1a4c9d89bff571d3d5842.jpg'} alt="" />
          </div>
